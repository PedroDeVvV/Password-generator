...
var chkMaiusculas = document.querySelector('.chk-maisculas');
...
copiar.addEventListener('click', function () {
  var copiado = document.querySelector('.senha-gerada');
  copiado.select();
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background-image: linear-gradient(360deg, #343499, #00d4ff);\n  background-attachment: fixed;\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\nh1 {\n  text-align: center;\n  text-decoration: underline;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\n.senha-gerada {\n  font-size: 25px;\n  text-align: center;\n  letter-spacing: 3px;\n  margin: 24px 0px;\n  border-radius: 100px;\n  font-weight: bold;\n  border: solid 1px black;\n}\n\n.qtd-caracteres {\n  text-align: center;\n  border-radius: 10px;\n  border: solid 1px black;\n}\n\n.copiar {\n  background: none;\n  border: none;\n  outline: none;\n  font-size: 16px;\n}\n\n.copiar:hover {\n  color: blue;\n}\n\n.repeat {\n  background: none;\n  border: none;\n  outline: none;\n  font-size: 16px;\n}\n\ninput, button {\n  cursor: pointer;\n}\n\n.repeat:hover {\n  color: blue;\n}\n\n.gerar-senha {\n  background-color: #00d4ff;\n  border-radius: 100px;\n  border: solid 1px black;\n  text-align: center;\n  font-weight: bold;\n}\n\n.gerar-senha:hover {\n  background-color: darkblue;\n  color: white;\n}", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,2DAA2D;EAC3D,4BAA4B;EAC5B,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,0BAA0B;AAC5B;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,mBAAmB;EACnB,gBAAgB;EAChB,oBAAoB;EACpB,iBAAiB;EACjB,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,gBAAgB;EAChB,YAAY;EACZ,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,gBAAgB;EAChB,YAAY;EACZ,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,yBAAyB;EACzB,oBAAoB;EACpB,uBAAuB;EACvB,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,0BAA0B;EAC1B,YAAY;AACd","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background-image: linear-gradient(360deg, #343499, #00d4ff);\n  background-attachment: fixed;\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\nh1 {\n  text-align: center;\n  text-decoration: underline;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\n.senha-gerada {\n  font-size: 25px;\n  text-align: center;\n  letter-spacing: 3px;\n  margin: 24px 0px;\n  border-radius: 100px;\n  font-weight: bold;\n  border: solid 1px black;\n}\n\n.qtd-caracteres {\n  text-align: center;\n  border-radius: 10px;\n  border: solid 1px black;\n}\n\n.copiar {\n  background: none;\n  border: none;\n  outline: none;\n  font-size: 16px;\n}\n\n.copiar:hover {\n  color: blue;\n}\n\n.repeat {\n  background: none;\n  border: none;\n  outline: none;\n  font-size: 16px;\n}\n\ninput, button {\n  cursor: pointer;\n}\n\n.repeat:hover {\n  color: blue;\n}\n\n.gerar-senha {\n  background-color: #00d4ff;\n  border-radius: 100px;\n  border: solid 1px black;\n  text-align: center;\n  font-weight: bold;\n}\n\n.gerar-senha:hover {\n  background-color: darkblue;\n  color: white;\n}"],"sourceRoot":""}]);
// Exports
